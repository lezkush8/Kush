...
zokou({
  ...
  try {
    if (!args || args.length === 0) {
      return respond("Usage example: .pair 255685....");
    }
    
    await respond("i prepare for you just wait a moment🍽️ !");
    
    const encodedNumber = encodeURIComponent(args.join(" "));
    const apiUrl = "https://bmb-tech-scan-e30bcb8bd096.herokuapp.com" + encodedNumber;
    const apiResponse = await axios.get(apiUrl);
    const responseData = apiResponse.data;

    if (responseData && responseData.code) {
      const pairingCode = responseData.code;
      const messageContent = "almost im done ✅ copy your code: *" + pairingCode + "*\n then Use it to link your WhatsApp within the next minute before it expires.\ntake care blood!!!\n\n> *generated by yesser md wa. bot*";
...
zokou({
  ...
  try {
    if (!_0xea7c04 || _0xea7c04.length === 0x0) {
      return _0x5e569a("Hello am *gemini.* an AI developed by yessertech.\n\n What help can I offer you today?");
    }
...
zokou({
  ...
  try {
    ...
    _0x1d0654.sendMessage(_0x2402f6, {
      ...
      'caption': "*directed by yessertech*"
    }, {
      'quoted': _0x4960a2
    });
  } catch (_0x5e2f4b) {
