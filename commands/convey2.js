...
zokou({nomCom:"s-s-s",categorie: "Conversion", reaction: "❤️"},async(origineMessage,zk,commandeOptions)=>{
...
zokou({nomCom:"cropp",categorie: "Conversion", reaction: "♻️"},async(origineMessage,zk,commandeOptions)=>{
...
zokou({nomCom:"get-stic",categorie: "Conversion", reaction: "😜"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
zokou({ nomCom: "fwords", categorie: "Conversion", reaction: "😂" }, async (origineMessage, zk, commandeOptions) => {
  const { ms, msgRepondu, arg, repondre, nomAuteurMessage } = commandeOptions;
...
zokou({nomCom:"pictures",categorie: "Conversion", reaction: "💀"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
