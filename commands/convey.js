...
zokou({nomCom:"croping",categorie: "Conversion", reaction: "♻️"},async(origineMessage,zk,commandeOptions)=>{
...
zokou({nomCom:"getstickers",categorie: "Conversion", reaction: "😜"},async(origineMessage,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
...
zokou({nomCom:"picture1",categorie: "Conversion", reaction: "💀"},async(dest,zk,commandeOptions)=>{
   const {ms , msgRepondu,arg,repondre,nomAuteurMessage} = commandeOptions ;
